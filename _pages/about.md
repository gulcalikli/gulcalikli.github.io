...
======
I am looking for Ph.D. students who are self-motivated with strong programming skills (e.g., Java, Python, C++, C#, etc.) and strong background in statistical analysis and/or Machine Learning (e.g., Deep Learning, NLP, LLMs). Experience in industrial/open-source software development is desirable. Feel free to <a href="mailto:handangul.calikli@glasgow.ac.uk">contact me</a> with your CV, academic transcript and publications (if any) if you are interested. You can read about the <i>Ph.D. Application Process</i> and <i>Ph.D. Scholarships</i> available at University of Glasgow and the School of Computing Science <a href="https://www.gla.ac.uk/schools/computing/postgraduateresearch/prospectivestudents/">here</a>. Usual <b>application deadline</b> is <b>31st January</b> every year. Email me if you want to know more about the open topics. 
