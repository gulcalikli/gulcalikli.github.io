...
<p><b style="color:red;">INTERESTED IN DOING A Ph.D.?</b> I am looking for self-motivated students with strong programming skills (e.g., Java, Python, C++, etc.) and background in statistical analysis and Machine Learning (e.g., Deep Learning, NLP, LLMs). Industrial or open-source software development experience is desirable. You can read about the <i>Ph.D. Application Process</i> and <i>Scholarships</i> available <a href="https://www.gla.ac.uk/schools/computing/postgraduateresearch/prospectivestudents/">here</a>. Usual <b>application deadline</b> is <b>31st January</b> every year. Feel free to <a href="mailto:handangul.calikli@glasgow.ac.uk">contact me</a> with your CV, academic transcript and publications (if any) ideally 1-2 months before the Ph.D. application deadline if you are interested.</p>
